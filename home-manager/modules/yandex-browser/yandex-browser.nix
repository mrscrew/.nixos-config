...
let
  # Актуальная версия (стабильная ветка) по состоянию на август 2026 г.
  version = {
    corporate = "24.7.1.1120-1";
    beta = "24.7.1.1120-1";
    stable = "26.6.1.1083-1";
  }.${edition};

  hash = {
    corporate = "sha256-rI19YmsC2p2Dsi6Grd8IyNdpjMHWwET3wcVw5r7545M=";
    beta = "sha256-EQjjaTMPQKaULITEF+MQuY1lRVXuOjyiGWuGQtIpIz0=";
    stable = "sha256-r7flAnoLagWn+Gsvn6m1spaWJ02LPnfwNIq+V+RdJMU=";
  }.${edition};
...
stdenv.mkDerivation rec {
  ...
  meta = with lib; {
    ...
    maintainers = with maintainers; [ mr_screw ];
